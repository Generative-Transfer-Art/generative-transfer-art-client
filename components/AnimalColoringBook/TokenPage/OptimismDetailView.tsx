...
function Erase({eraserContract, coloringBookContract, nftInfo, callback}){
    ...
    const update = async (id) => {
        ...
        const isApproved = approved.includes(process.env.NEXT_PUBLIC_OPTIMISM_ANIMAL_COLORING_BOOK)
        if (!isApproved) {
    ...
    const approve = async () => {
        ...
        const t = await eraserContract.approve(process.env.NEXT_PUBLIC_OPTIMISM_ANIMAL_COLORING_BOOK, id)
    ...
    const waitForApproval = async () => {
        const filter = eraserContract.filters.Approval(nftInfo.owner, process.env.NEXT_PUBLIC_OPTIMISM_ANIMAL_COLORING_BOOK, ethers.BigNumber.from(id))
